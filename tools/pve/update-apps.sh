...
source <(curl -fsSL https://raw.githubusercontent.com/mr-u0b0dy/ProxmoxVE/refs/heads/main/misc/core.func)
...
for container in $CHOICE; do
  ...
  script=$(curl -fsSL https://raw.githubusercontent.com/mr-u0b0dy/ProxmoxVE/main/ct/${service}.sh)
