...
#
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/mr-u0b0dy/ProxmoxVE/main/tools/pve/cron-update-lxcs.sh)"

set -euo pipefail

REPO_URL="https://raw.githubusercontent.com/mr-u0b0dy/ProxmoxVE/main"
