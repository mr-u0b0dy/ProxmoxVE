...
ADDON_SCRIPT="https://raw.githubusercontent.com/mr-u0b0dy/ProxmoxVE/main/tools/addon/dockge.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/mr-u0b0dy/ProxmoxVE/main/tools/addon/dockge.sh)"
MIGRATION_EOF
