...
ADDON_SCRIPT="https://raw.githubusercontent.com/mr-u0b0dy/ProxmoxVE/main/tools/addon/komodo.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/mr-u0b0dy/ProxmoxVE/main/tools/addon/komodo.sh)"
MIGRATION_EOF
