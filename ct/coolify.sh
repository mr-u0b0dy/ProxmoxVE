...
ADDON_SCRIPT="https://raw.githubusercontent.com/mr-u0b0dy/ProxmoxVE/main/tools/addon/coolify.sh"
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/mr-u0b0dy/ProxmoxVE/main/tools/addon/coolify.sh)"
MIGRATION_EOF
