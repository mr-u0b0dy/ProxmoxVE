...
Official discussion: [GitHub #8126](https://github.com/mr-u0b0dy/ProxmoxVE/discussions/8126)
...
1. Open an issue on [GitHub](https://github.com/mr-u0b0dy/ProxmoxVE/issues)
2. Include:
   - Exit code number
   - Error message
   - Steps to reproduce
