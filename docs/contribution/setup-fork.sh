...
# upstream   https://github.com/mr-u0b0dy/ProxmoxVE.git (fetch)
# upstream   https://github.com/mr-u0b0dy/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/mr-u0b0dy/ProxmoxVE"
echo ""
