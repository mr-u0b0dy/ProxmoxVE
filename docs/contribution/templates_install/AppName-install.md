...
```bash
#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/mr-u0b0dy/ProxmoxVE/main/misc/install.func)
...
- [Trip](https://github.com/mr-u0b0dy/ProxmoxVE/blob/main/install/trip-install.sh)
- [Thingsboard](https://github.com/mr-u0b0dy/ProxmoxVE/blob/main/install/thingsboard-install.sh)
- [UniFi](https://github.com/mr-u0b0dy/ProxmoxVE/blob/main/install/unifi-install.sh)
